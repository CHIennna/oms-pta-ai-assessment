...
const publicFiles = new Map([
  ['/', 'index.html'], ['/index.html', 'index.html'], ['/styles.css', 'styles.css'], ['/polish.css', 'polish.css'], ['/judge.css', 'judge.css'], ['/admin.css', 'admin.css'], ['/layout-fix.css', 'layout-fix.css'], ['/pta-controls.css', 'pta-controls.css'], ['/pta-reference.css', 'pta-reference.css'], ['/app.js', 'app.js'], ['/polish.js', 'polish.js'], ['/judge.js', 'judge.js'], ['/admin.js', 'admin.js'], ['/navigation.js', 'navigation.js'], ['/pta-controls.js', 'pta-controls.js'], ['/markdown-import.js', 'markdown-import.js'], ['/pta-reference.js', 'pta-reference.js']
]);
